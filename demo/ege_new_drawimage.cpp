...
///
/// 1. 白底蓝条纹背景绘制
/// 2. 第一个三角形的绘制，首先绘制到PIMAGE变量img上，然后绘制到屏幕
/// 3. 第二个三角形的绘制，将img的部分（实际上为完整的）绘制到屏幕
/// 4. 第三个三角形的绘制，通过变换矩阵将img旋转45度后绘制
/// 5. 第四个三角形的绘制，绘制还原后的img
///
/// @date 2023.6.23(created on 2020.10.25)
///
///
////////////////////////////////////////
